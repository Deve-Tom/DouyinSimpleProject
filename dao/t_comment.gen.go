...
func newComment(db *gorm.DB, opts ...gen.DOOption) comment {
	...
	_comment.User = commentBelongsToUser{
		...
		Videos: struct {
			...
			Comments: struct {
				...
				RelationField: field.NewRelation("User.Videos.Comments", "entity.Comment"),
				User: struct {
					field.RelationField
				}{
					RelationField: field.NewRelation("User.Videos.Comments.User", "entity.User"),
				},
				Video: struct {
					field.RelationField
				}{
					RelationField: field.NewRelation("User.Videos.Comments.Video", "entity.Video"),
				},
			},
		},
		Comments: struct {
			...
			RelationField: field.NewRelation("User.Comments", "entity.Comment"),
		},
	...
	_comment.Video = commentBelongsToVideo{
		...
		RelationField: field.NewRelation("Video", "entity.Video"),
	}
...
type commentBelongsToUser struct {
	db *gorm.DB
...
func (a commentBelongsToUser) Where(conds ...field.Expr) *commentBelongsToUser {
	if len(conds) == 0 {
		return &a
	}
...
func (a commentBelongsToUser) WithContext(ctx context.Context) *commentBelongsToUser {
	a.db = a.db.WithContext(ctx)
	return &a
}

func (a commentBelongsToUser) Model(m *entity.Comment) *commentBelongsToUserTx {
	return &commentBelongsToUserTx{a.db.Model(m).Association(a.Name())}
}

type commentBelongsToUserTx struct{ tx *gorm.Association }

func (a commentBelongsToUserTx) Find() (result *entity.User, err error) {
	return result, a.tx.Find(&result)
}

func (a commentBelongsToUserTx) Append(values ...*entity.User) (err error) {
...
func (a commentBelongsToUserTx) Replace(values ...*entity.User) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a commentBelongsToUserTx) Delete(values ...*entity.User) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a commentBelongsToUserTx) Clear() error {
	return a.tx.Clear()
}

func (a commentBelongsToUserTx) Count() int64 {
	return a.tx.Count()
}

type commentBelongsToVideo struct {
	db *gorm.DB

	field.RelationField
}

func (a commentBelongsToVideo) Where(conds ...field.Expr) *commentBelongsToVideo {
	if len(conds) == 0 {
		return &a
	}
...
func (a commentBelongsToVideo) WithContext(ctx context.Context) *commentBelongsToVideo {
	a.db = a.db.WithContext(ctx)
	return &a
}

func (a commentBelongsToVideo) Model(m *entity.Comment) *commentBelongsToVideoTx {
	return &commentBelongsToVideoTx{a.db.Model(m).Association(a.Name())}
}

type commentBelongsToVideoTx struct{ tx *gorm.Association }

func (a commentBelongsToVideoTx) Find() (result *entity.Video, err error) {
	return result, a.tx.Find(&result)
}

func (a commentBelongsToVideoTx) Append(values ...*entity.Video) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a commentBelongsToVideoTx) Replace(values ...*entity.Video) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a commentBelongsToVideoTx) Delete(values ...*entity.Video) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a commentBelongsToVideoTx) Clear() error {
	return a.tx.Clear()
}

func (a commentBelongsToVideoTx) Count() int64 {
	return a.tx.Count()
}
